...
export function AuthProvider({ children }) {
  ...
  const STORE_SELECT = 'id, owner_id, status, store_name, owner_name, customer_tiers, plan_name, subscription_status, plan_expires_at, phone, email, whatsapp_phone, owner_whatsapp, has_image_search, has_voice_search, ai_models, ai_models_limit, has_storefront, analytics, product_limit, image_storage_gb, conversation_limit, monthly_budget_inr, address, _conv_used, _ai_used, _design_used, design_studio_limit, _ai_studio_suite_used, _ai_studio_suite_limit, voice_profile, voice_examples, voice_updated_at, selfie_tryon_tier, whatsapp_phone_number_id, waba_id, wa_access_token, logo_url, name_style_url';
